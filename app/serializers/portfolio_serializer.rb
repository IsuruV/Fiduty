class PortfolioSerializer < ActiveModel::Serializer
  attributes :id, :fund_type, :investment_type, :name, :symbol, :description, :avg_1, :real_time_quotes, :beta, :alpha, :meanAnnualReturn, :rSquared, :stdDev, :sharpeRatio, :treynorRatio, :user_portfolios, :reviews
  has_one :advisor
end
